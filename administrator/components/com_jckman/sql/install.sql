...
(94,'Mobileimage','mobileimage','plugin',1,1,1,'icon.png',1,'',NULL)
...
DELETE FROM `#__jckplugins` WHERE id = 91;
...
SET @pluginid = (SELECT id from #__jckplugins WHERE name='html5support');

UPDATE #__jckplugins
SET parentid = @pluginid
...
CREATE TABLE IF NOT EXISTS `#__jcklanguages` (
	  `id` int(11) NOT NULL auto_increment,
	   tag  varchar(5),
